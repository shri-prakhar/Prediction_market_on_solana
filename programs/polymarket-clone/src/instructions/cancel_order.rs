...
use crate::constants::{ASKS_SEEDS, BIDS_SEED, EMPTY_INDEX, EVRNT_QUEUE_SEED, MARKET_SEED, MAX_EVENTS, MAX_ORDER_PER_TRADER, POSITION_SEED};
...
pub fn cancle_order_handler(ctx:Context<CancelOrder> , params: CancelOrderParams) -> Result<()> {
    ...
    trader_position.active_orders = trader_position.active_orders.checked_sub(1).ok_or(MarketError::MathError)?;

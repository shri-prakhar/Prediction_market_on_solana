...
use crate::{constants::MARKET_SEED, error::MarketError, state::{Market, MarketStatus}};
...
pub fn claim_reward(ctx: Context<ClaimReward> , amount: u64) -> Result<()>{
    ...
    let signer_seeds: &[&[&[u8]]] = &[&[MARKET_SEED , &ctx.accounts.market.market_id.to_be_bytes(), &[bump]]];

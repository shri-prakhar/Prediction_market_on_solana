...
#[repr(u8)] //repr with u8 is generally used with enums and structs especially with enums 
...
#[repr(C)] // repr with C type aligns and assigns the memory with strict C type memory allocation 
